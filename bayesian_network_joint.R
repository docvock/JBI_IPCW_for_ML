###################################
# File: ./bayesian_network_joint.R
#		Purpose: Create figure of the Bayesian network
#   Author: David M. Vock
#   Last Modified: January 8, 2016
#   Relies On: ./coord_use.txt 
#   Files Created: ./bayesian_network_joint.pdf 
#										./bayesian_network_joint.eps
####################################

library(igraph)
library(shape)

setwd("C:\\Users\\bstvock\\Documents\\research\\IPCW_machine_learning\\ML-for-censored-data\\code")
Edges <- data.frame(
...
pdf("C:\\Users\\bstvock\\Documents\\research\\IPCW_machine_learning\\ML-for-censored-data\\code\\bayesian_network_joint.pdf",
	height = 6, width = 5)
setEPS()
postscript("C:\\Users\\bstvock\\Documents\\research\\IPCW_machine_learning\\ML-for-censored-data\\code\\bayesian_network_joint.eps",
	height = 6, width = 5, fonts=c("serif"))
