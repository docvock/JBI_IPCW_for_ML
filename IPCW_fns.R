###################################
# File: ./IPCW_fns.R
#		Purpose: Create wrapper functions to implement recursive partitioning, logistic regression, 
#							GAMs, Bayesian networks, and k-NN. The functions perform any needed tuning parameter
#							selection and returns the predicted probability of having an adverse event for the 
#							test set (if given) or the training set.
#   Author: David M. Vock
...
#################################
## generalized additive model (GAM) functions
#################################
